        ...
        "messages": [
            {
                ...
                1. **date**: The specific date or time period when the user wants to book the artist in '%Y-%m-%d' formate.
...
# Example usage
open_api_key = ""
# query = "I'm looking to book a pop singer for my wedding on July 15th. My budget is around $5000. The event will be held at Central Park in New York. I also need a sound system to be provided."
